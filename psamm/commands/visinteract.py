...
def build_network(self, nm, mm, rxn_set, network, fba_dropdown, nodes, edges):
	...
	for i in nm.compartments:
		comp.append(i.id)
	# are these the model colors? they don't match
...
class InteractiveCommand(MetabolicMixin, SolverCommandMixin,
	...
	def callbacks(self, _app):
		...
		def render_page_content(pathname, rsb_clicks, open_clicks):
			...
			help_content = html.Div([
				dbc.Row([
					dbc.Col([
						html.Div([
							html.H4("Pathways", className="text-center", style={"margin-top": "20px", "color": "#102A5F"}),
					...
					dbc.Col([
						html.Div([
							html.H4("Reactions", className="text-center", style={"margin-top": "20px", "color": "#102A5F"}),
					...
					dbc.Col([
						html.Div([
							html.H4("Gene Delete", className="text-center", style={"margin-top": "20px", "color": "#102A5F"}),
				...
				dbc.Row([
					dbc.Col([
						html.Div([
							html.H4("Element Transfer Networks", className="text-center", style={"margin-top": "10px", "color": "#102A5F"}),
					...
					dbc.Col([
						html.Div([
							html.H4("Path Search", className="text-center", style={"margin-top": "10px", "color": "#102A5F"}),
					...
					dbc.Col([
						html.Div([
							html.H4("Compound Search", className="text-center", style={"margin-top": "10px", "color": "#102A5F"}),
				...
				dbc.Row([
					html.Div([
						html.H4("Flux Analysis", className="text-center", style={"margin-top": "10px", "color": "#102A5F"}),
						html.H5("Use the dropdown to choose a reaction to optimize for flux balance analysis. Flux is visualized in blue.",
							className="text-center", style={"color": "#102A5F", "text-transform": "none"}),
						]),
					]),
				])
			# page layout (contains the image, the help title, and the help content)
			home = html.Div(id="home_page", style={'position':'absolute', 'z-index':'1000', 
				"top": "0px", "left": "16rem"}, children=[
				image,
				html.H1("PSAMM HELP", id="help_title", className="text-center", style={"color": "#102A5F", "margin-top": "20px"}),
				help_content,
				])
					...
					dbc.Row([
						html.Div([
								dbc.Button("controls", id='ctrl',color="primary", style={"background-color": "#102A5F", 
									"margin-left": "20px", "border-radius": "8px", "margin-top": "10px"}),
								dbc.Button("constraints", id='cnst',color="primary", style={"margin-top": "10px",
									"margin-left": "10px", "background-color": "#102A5F", "border-radius": "8px"}),
							]),
						]),
					dbc.Row([
						html.Div([
								dbc.Button("exchange", id='exg',color="primary", style={"margin-bottom": "20px",
									"margin-left": "20px", "background-color": "#102A5F", "border-radius": "8px", "margin-top": "10px"},),
								dbc.Button("model stats", id='ms',color="primary", style={"margin-left": "10px", "margin-bottom": "20px",
					...
					dbc.Row([
						dbc.Col([
							html.Div(id="node-data", className="text-center", children=[
								html.H6("Click on a node to see its details", style={"margin-top": "10px", "color": "#102A5F"})
								], style={"background-color": "#bdcef2", "border-radius": "8px", "padding": "10px"}),
							]),
						]),
					]), {"margin-top": "120px", "background-color": "#5d80c9", "border-radius": "8px", "display": "block"}, \
						{"margin-top": "5px", "background-color": "#5d80c9", "border-radius": "8px", "display": "block"}

			# SIMULATE PAGE SETUP ----------------------------------------------
			# contains the model, the menu, and the flux analysis report
			sim = dbc.Container([
				dbc.Row([
					dbc.Col([s_n], width=7),
				...
				dbc.Row([
					html.Div(id="fba-data", className="results", children=[], style={"margin-top": "20px", 
						"background-color": "#bdcef2", "border-radius": "8px", "padding": "20px", "color": "#102A5F"}),
					]),
				], fluid=True)
			...
			if dash.callback_context.triggered[0]['prop_id'] == \
					...
					return sim, {"margin-top": "120px", "background-color": "#5d80c9", "border-radius": "8px", "display": "block"}, \
					{"margin-top": "5px", "background-color": "#5d80c9", "border-radius": "8px", "display": "block"}

			# SIDEBAR PAGE BUTTON FUNCTIONALITY --------------------------------
			# returns the proper page layout based on the button clicked 
			if pathname == "/":
				# style components returned hide the open/close menu buttons (on simulate tab only)
				return home, {"display": "none"}, {"display": "none"}
			elif pathname == "/simulate":
				return sim, {"margin-top": "120px", "background-color": "#5d80c9", "border-radius": "8px", "display": "block"}, \
				{"margin-top": "5px", "background-color": "#5d80c9", "border-radius": "8px", "display": "block"}
			elif pathname == "/curate":
				return html.P("Curate: coming soon!"), {"display": "none"}, {"display": "none"}
		...
		# operates the simulate page menu
		@_app.callback(
		...
		# returns the control tab layout to the menu
		def open_ctrl(nclicks):
			...
			if dash.callback_context.triggered[0]['prop_id'] == \
				...
				return html.Div(id='control-tab', className='control-tab', children=[
					...
					dbc.Row([
						html.Div([
							html.H5("Pathways", className="text-center",
								style={"margin-top": "10px", "color": "#102A5F"}),
							dcc.Dropdown(id="pathways_dropdown",options=[
								...
								optionHeight=80, style={"margin-top": "10px", "color": "#102A5F"}),
							]),
						]),
					dbc.Row([
						html.Div([
					...
					dbc.Row([
						html.Div([
							html.H5("Element Transfer Networks", className="text-center", style={"margin-top": "15px", "color": "#102A5F"}),
					...
					dbc.Row([
						html.Div([
							html.H5("Compound Search", className="text-center", style={"margin-top": "15px", "color": "#102A5F"}),
					...
					dbc.Row(html.H5("Path Search", className="text-center", style={"margin-top": "15px", "color": "#102A5F"}),),
					dbc.Row([
						dbc.Col([
							html.Div([
					...
					dbc.Row([
						html.Div([
							html.H5("Gene Delete", className="text-center", style={"margin-top": "15px", "color": "#102A5F"}),
					...
					dbc.Row([
						html.Div([
							html.H5("Flux Analysis", className="text-center", style={"margin-top": "15px", "color": "#102A5F"}),
					...
					dbc.Row([
						html.Div([
							dbc.Button("Submit",id="btn_sub", size="sm", style={"margin-top": "30px", "margin-left": "5px",
								"background-color": "#5d80c9", "border-radius": "8px"}),
							dbc.Button("Download CSV",id="btn_tsv", size="sm", style={"margin-top": "30px",
								"background-color": "#5d80c9","border-radius": "8px", "margin-left": "5px"}),
							dcc.Download(id="download_r"),
							dcc.Download(id="download_c"),
							dbc.Button("Download png", id="btn-get-png", size="sm", style={"margin-top": "30px",
								"background-color": "#5d80c9", "border-radius": "8px", "margin-left": "5px"}),
							dcc.Download(id="downloadpng"),
							])
						]),
					])
		# returns the constraint tab layout to the menu
				...
				return html.Div([
							...
							dbc.Row([
								html.Div([
									...
									style={"color":"#102A5F", "margin-top":"10px"}),
									html.H5(id="constraint-confirm", className="text-center", children="",
										style={"color":"#102A5F", "margin-top":"10px", "text-transform": "none"}),
							...
							dbc.Row([
								html.Div([
									dbc.Button("Load constraints", id="constraint-load", size="sm", style={"background-color": "#5d80c9",
										"border-radius": "8px", "margin-left":"17px", "margin-top": "10px"}),
									dbc.Button("Update constraints", id="constraint-modify", size="sm", style={"background-color": "#5d80c9",
										"border-radius": "8px", "margin-left": "10px", "margin-top": "10px"}),
									]),
								]),
							...
							dbc.Row([
								html.Div([
									dbc.Button("Save constraints", id="constraint-save", size="sm", style={"background-color": "#5d80c9",
										"border-radius": "8px", "margin-left": "95px", "margin-top": "10px"})
									]),
								]),
						])
		# returns the exchange tab layout to the menu 
		...
		def load_constraints(nclicks):
			...
			if dash.callback_context.triggered[0]['prop_id'] == \
				...
				contents.append(html.P("Add New Constraint:", style={"margin-top": "10px"}))
				contents.append(
		...
		# functionality of the exchange save button 
		@_app.callback(
		...
		# allows user to click on nodes and see data for each node
		@_app.callback(
		...
		# also not sure what this does yet (might be part of the curate tab)
		...
		# functionality of the submit button on the controls tab (simulate page)
		@_app.callback(
			[Output("net", "elements"),
			...
			if isinstance(pathways_dropdown, list) \
				...
				if obj_flux != 0:
					...
					contents.append(html.H5("{} flux "
									"is {}".format(fba_dropdown, obj_flux), style={"text-transform": "none", "color": "#102A5F"}))
				else:
					contents = []
					contents.append(html.H5("No flux through the network", style={"text-transform": "none", "color": "#102A5F"}))
