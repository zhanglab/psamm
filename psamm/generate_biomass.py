...
def update_model_yaml(model_path, model_dict, cell_compartment, biomass_name, yaml_args):
...
class main(Command):
    ...
    def run(self):
        ...
        bio_rxn_entry = return_biomass_rxn(df, self._args.biomass, cell_compartment)
